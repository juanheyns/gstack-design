 ...
 * 2. Injects __DESIGN_SERVER_URL so the board can POST feedback here
 ...
 *
 * The agent typically backgrounds design serve and polls for feedback-pending.json.
...
export async function serve(options: ServeOptions): Promise<void> {
  ...
  async function handleFeedback(req: Request): Promise<Response> {
    ...
    // (agent typically backgrounds design serve, can't read stdout)
